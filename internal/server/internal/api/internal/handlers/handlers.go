...
func (h *Handlers) init() {
	...
	apiGroup.POST("/delete_task", h.DeleteTaskById)
	apiGroup.POST("/update_task", h.UpdateTaskById)
	apiGroup.POST("/get_tasks", h.GetTasksByOwner)
	apiGroup.POST("/get_task", h.GetTaskById)
}
